...
export const routes = {
  ...
  "texas-eagle-2020-09": {
    ...
    segments: [
      { order: 1, from: { name: "Los Angeles, CA", lat: 34.0522, lng: -118.2437 }, to: { name: "Pomona, CA", lat: 34.0551, lng: -117.7522 } },
      { order: 2, from: { name: "Pomona, CA", lat: 34.0551, lng: -117.7522 }, to: { name: "Ontario, CA", lat: 34.0633, lng: -117.6509 } },
      { order: 3, from: { name: "Ontario, CA", lat: 34.0633, lng: -117.6509 }, to: { name: "Palm Springs, CA", lat: 33.8303, lng: -116.5453 } },
      { order: 4, from: { name: "Palm Springs, CA", lat: 33.8303, lng: -116.5453 }, to: { name: "Yuma, AZ", lat: 32.7253, lng: -114.6244 } },
      { order: 5, from: { name: "Yuma, AZ", lat: 32.7253, lng: -114.6244 }, to: { name: "Maricopa, AZ", lat: 33.0581, lng: -112.0476 } },
      { order: 6, from: { name: "Maricopa, AZ", lat: 33.0581, lng: -112.0476 }, to: { name: "Tucson, AZ", lat: 32.2217, lng: -110.9265 } },
      { order: 7, from: { name: "Tucson, AZ", lat: 32.2217, lng: -110.9265 }, to: { name: "Benson, AZ", lat: 31.9678, lng: -110.2945 } },
      { order: 8, from: { name: "Benson, AZ", lat: 31.9678, lng: -110.2945 }, to: { name: "Lordsburg, NM", lat: 32.3503, lng: -108.7070 } },
      { order: 9, from: { name: "Lordsburg, NM", lat: 32.3503, lng: -108.7070 }, to: { name: "Deming, NM", lat: 32.2687, lng: -107.7586 } },
      { order: 10, from: { name: "Deming, NM", lat: 32.2687, lng: -107.7586 }, to: { name: "El Paso, TX", lat: 31.7619, lng: -106.4850 } },
      { order: 11, from: { name: "El Paso, TX", lat: 31.7619, lng: -106.4850 }, to: { name: "Alpine, TX", lat: 30.3583, lng: -103.6616 } },
      { order: 12, from: { name: "Alpine, TX", lat: 30.3583, lng: -103.6616 }, to: { name: "Sanderson, TX", lat: 30.1438, lng: -102.3940 } },
      { order: 13, from: { name: "Sanderson, TX", lat: 30.1438, lng: -102.3940 }, to: { name: "Del Rio, TX", lat: 29.3633, lng: -100.8968 } },
      { order: 14, from: { name: "Del Rio, TX", lat: 29.3633, lng: -100.8968 }, to: { name: "San Antonio, TX", lat: 29.4241, lng: -98.4936 } },
      { order: 15, from: { name: "San Antonio, TX", lat: 29.4241, lng: -98.4936 }, to: { name: "San Marcos, TX", lat: 29.8833, lng: -97.9414 } },
      { order: 16, from: { name: "San Marcos, TX", lat: 29.8833, lng: -97.9414 }, to: { name: "Austin, TX", lat: 30.2672, lng: -97.7431 } },
      { order: 17, from: { name: "Austin, TX", lat: 30.2672, lng: -97.7431 }, to: { name: "Taylor, TX", lat: 30.5705, lng: -97.4092 } },
      { order: 18, from: { name: "Taylor, TX", lat: 30.5705, lng: -97.4092 }, to: { name: "Temple, TX", lat: 31.0982, lng: -97.3428 } },
      { order: 19, from: { name: "Temple, TX", lat: 31.0982, lng: -97.3428 }, to: { name: "McGregor, TX", lat: 31.4443, lng: -97.4092 } },
      { order: 20, from: { name: "McGregor, TX", lat: 31.4443, lng: -97.4092 }, to: { name: "Cleburne, TX", lat: 32.3476, lng: -97.3867 } },
      { order: 21, from: { name: "Cleburne, TX", lat: 32.3476, lng: -97.3867 }, to: { name: "Fort Worth, TX", lat: 32.7555, lng: -97.3308 } },
      { order: 22, from: { name: "Fort Worth, TX", lat: 32.7555, lng: -97.3308 }, to: { name: "Dallas, TX", lat: 32.7767, lng: -96.7970 } },
      { order: 23, from: { name: "Dallas, TX", lat: 32.7767, lng: -96.7970 }, to: { name: "Mineola, TX", lat: 32.6632, lng: -95.4883 } },
      { order: 24, from: { name: "Mineola, TX", lat: 32.6632, lng: -95.4883 }, to: { name: "Longview, TX", lat: 32.5007, lng: -94.7404 } },
      { order: 25, from: { name: "Longview, TX", lat: 32.5007, lng: -94.7404 }, to: { name: "Marshall, TX", lat: 32.5448, lng: -94.3677 } },
      { order: 26, from: { name: "Marshall, TX", lat: 32.5448, lng: -94.3677 }, to: { name: "Texarkana, AR/TX", lat: 33.4418, lng: -94.0377 } },
      { order: 27, from: { name: "Texarkana, AR/TX", lat: 33.4418, lng: -94.0377 }, to: { name: "Hope, AR", lat: 33.6670, lng: -93.5916 } },
      { order: 28, from: { name: "Hope, AR", lat: 33.6670, lng: -93.5916 }, to: { name: "Arkadelphia, AR", lat: 34.1209, lng: -93.0538 } },
      { order: 29, from: { name: "Arkadelphia, AR", lat: 34.1209, lng: -93.0538 }, to: { name: "Malvern, AR", lat: 34.3623, lng: -92.8132 } },
      { order: 30, from: { name: "Malvern, AR", lat: 34.3623, lng: -92.8132 }, to: { name: "Little Rock, AR", lat: 34.7465, lng: -92.2896 } },
      { order: 31, from: { name: "Little Rock, AR", lat: 34.7465, lng: -92.2896 }, to: { name: "Walnut Ridge, AR", lat: 36.0687, lng: -90.9593 } },
      { order: 32, from: { name: "Walnut Ridge, AR", lat: 36.0687, lng: -90.9593 }, to: { name: "Poplar Bluff, MO", lat: 36.7570, lng: -90.3929 } },
      { order: 33, from: { name: "Poplar Bluff, MO", lat: 36.7570, lng: -90.3929 }, to: { name: "Arcadia, MO", lat: 37.5850, lng: -90.6262 } },
      { order: 34, from: { name: "Arcadia, MO", lat: 37.5850, lng: -90.6262 }, to: { name: "St. Louis, MO", lat: 38.6270, lng: -90.1994 } },
      { order: 35, from: { name: "St. Louis, MO", lat: 38.6270, lng: -90.1994 }, to: { name: "Alton, IL", lat: 38.8906, lng: -90.1843 } },
      { order: 36, from: { name: "Alton, IL", lat: 38.8906, lng: -90.1843 }, to: { name: "Carlinville, IL", lat: 39.2797, lng: -89.8817 } },
      { order: 37, from: { name: "Carlinville, IL", lat: 39.2797, lng: -89.8817 }, to: { name: "Springfield, IL", lat: 39.7817, lng: -89.6501 } },
      { order: 38, from: { name: "Springfield, IL", lat: 39.7817, lng: -89.6501 }, to: { name: "Lincoln, IL", lat: 40.1481, lng: -89.3648 } },
      { order: 39, from: { name: "Lincoln, IL", lat: 40.1481, lng: -89.3648 }, to: { name: "Bloomington-Normal, IL", lat: 40.4842, lng: -88.9937 } },
      { order: 40, from: { name: "Bloomington-Normal, IL", lat: 40.4842, lng: -88.9937 }, to: { name: "Pontiac, IL", lat: 40.8808, lng: -88.6298 } },
      { order: 41, from: { name: "Pontiac, IL", lat: 40.8808, lng: -88.6298 }, to: { name: "Joliet, IL", lat: 41.5250, lng: -88.0817 } },
      { order: 42, from: { name: "Joliet, IL", lat: 41.5250, lng: -88.0817 }, to: { name: "Chicago, IL", lat: 41.8781, lng: -87.6298 } }
    ]
  },
  ...
  "crescent-2020-08": {
    ...
    segments: [
      { order: 1, from: { name: "New Orleans, LA", lat: 29.9511, lng: -90.0715 }, to: { name: "Slidell, LA", lat: 30.2752, lng: -89.7812 } },
      { order: 2, from: { name: "Slidell, LA", lat: 30.2752, lng: -89.7812 }, to: { name: "Picayune, MS", lat: 30.5255, lng: -89.6795 } },
      { order: 3, from: { name: "Picayune, MS", lat: 30.5255, lng: -89.6795 }, to: { name: "Hattiesburg, MS", lat: 31.3271, lng: -89.2903 } },
      { order: 4, from: { name: "Hattiesburg, MS", lat: 31.3271, lng: -89.2903 }, to: { name: "Laurel, MS", lat: 31.6940, lng: -89.1307 } },
      { order: 5, from: { name: "Laurel, MS", lat: 31.6940, lng: -89.1307 }, to: { name: "Meridian, MS", lat: 32.3643, lng: -88.7034 } },
      { order: 6, from: { name: "Meridian, MS", lat: 32.3643, lng: -88.7034 }, to: { name: "Tuscaloosa, AL", lat: 33.2098, lng: -87.5692 } },
      { order: 7, from: { name: "Tuscaloosa, AL", lat: 33.2098, lng: -87.5692 }, to: { name: "Birmingham, AL", lat: 33.5186, lng: -86.8104 } },
      { order: 8, from: { name: "Birmingham, AL", lat: 33.5186, lng: -86.8104 }, to: { name: "Anniston, AL", lat: 33.6598, lng: -85.8316 } },
      { order: 9, from: { name: "Anniston, AL", lat: 33.6598, lng: -85.8316 }, to: { name: "Atlanta, GA", lat: 33.7490, lng: -84.3880 } },
      { order: 10, from: { name: "Atlanta, GA", lat: 33.7490, lng: -84.3880 }, to: { name: "Gainesville, GA", lat: 34.2979, lng: -83.8241 } },
      { order: 11, from: { name: "Gainesville, GA", lat: 34.2979, lng: -83.8241 }, to: { name: "Toccoa, GA", lat: 34.5773, lng: -83.3321 } },
      { order: 12, from: { name: "Toccoa, GA", lat: 34.5773, lng: -83.3321 }, to: { name: "Clemson, SC", lat: 34.6834, lng: -82.8374 } },
      { order: 13, from: { name: "Clemson, SC", lat: 34.6834, lng: -82.8374 }, to: { name: "Greenville, SC", lat: 34.8526, lng: -82.3940 } },
      { order: 14, from: { name: "Greenville, SC", lat: 34.8526, lng: -82.3940 }, to: { name: "Spartanburg, SC", lat: 34.9496, lng: -81.9320 } },
      { order: 15, from: { name: "Spartanburg, SC", lat: 34.9496, lng: -81.9320 }, to: { name: "Gastonia, NC", lat: 35.2621, lng: -81.1873 } },
      { order: 16, from: { name: "Gastonia, NC", lat: 35.2621, lng: -81.1873 }, to: { name: "Charlotte, NC", lat: 35.2271, lng: -80.8431 } },
      { order: 17, from: { name: "Charlotte, NC", lat: 35.2271, lng: -80.8431 }, to: { name: "Salisbury, NC", lat: 35.6704, lng: -80.4742 } },
      { order: 18, from: { name: "Salisbury, NC", lat: 35.6704, lng: -80.4742 }, to: { name: "High Point, NC", lat: 35.9557, lng: -80.0053 } },
      { order: 19, from: { name: "High Point, NC", lat: 35.9557, lng: -80.0053 }, to: { name: "Greensboro, NC", lat: 36.0726, lng: -79.7920 } },
      { order: 20, from: { name: "Greensboro, NC", lat: 36.0726, lng: -79.7920 }, to: { name: "Danville, VA", lat: 36.5860, lng: -79.3950 } },
      { order: 21, from: { name: "Danville, VA", lat: 36.5860, lng: -79.3950 }, to: { name: "Lynchburg, VA", lat: 37.4138, lng: -79.1422 } },
      { order: 22, from: { name: "Lynchburg, VA", lat: 37.4138, lng: -79.1422 }, to: { name: "Charlottesville, VA", lat: 38.0293, lng: -78.4767 } },
      { order: 23, from: { name: "Charlottesville, VA", lat: 38.0293, lng: -78.4767 }, to: { name: "Culpeper, VA", lat: 38.4732, lng: -77.9966 } },
      { order: 24, from: { name: "Culpeper, VA", lat: 38.4732, lng: -77.9966 }, to: { name: "Manassas, VA", lat: 38.7509, lng: -77.4753 } },
      { order: 25, from: { name: "Manassas, VA", lat: 38.7509, lng: -77.4753 }, to: { name: "Alexandria, VA", lat: 38.8048, lng: -77.0469 } },
      { order: 26, from: { name: "Alexandria, VA", lat: 38.8048, lng: -77.0469 }, to: { name: "Washington, DC", lat: 38.9072, lng: -77.0369 } },
      { order: 27, from: { name: "Washington, DC", lat: 38.9072, lng: -77.0369 }, to: { name: "Baltimore, MD", lat: 39.2904, lng: -76.6122 } },
      { order: 28, from: { name: "Baltimore, MD", lat: 39.2904, lng: -76.6122 }, to: { name: "Wilmington, DE", lat: 39.7391, lng: -75.5398 } },
      { order: 29, from: { name: "Wilmington, DE", lat: 39.7391, lng: -75.5398 }, to: { name: "Philadelphia, PA", lat: 39.9526, lng: -75.1652 } },
      { order: 30, from: { name: "Philadelphia, PA", lat: 39.9526, lng: -75.1652 }, to: { name: "Trenton, NJ", lat: 40.2206, lng: -74.7597 } },
      { order: 31, from: { name: "Trenton, NJ", lat: 40.2206, lng: -74.7597 }, to: { name: "Metropark, NJ", lat: 40.5662, lng: -74.3218 } },
      { order: 32, from: { name: "Metropark, NJ", lat: 40.5662, lng: -74.3218 }, to: { name: "Newark, NJ", lat: 40.7357, lng: -74.1724 } },
      { order: 33, from: { name: "Newark, NJ", lat: 40.7357, lng: -74.1724 }, to: { name: "New York, NY", lat: 40.7128, lng: -74.0060 } }
    ]
  },
