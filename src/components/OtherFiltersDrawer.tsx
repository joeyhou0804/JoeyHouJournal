...
type FilterId = 'all_destinations' | 'visit_by_myself' | 'visit_with_others' | 'stay_overnight' | 'visit_on_train' | 'visit_more_than_once'
...
export default function OtherFiltersDrawer({ isOpen, onClose }: OtherFiltersDrawerProps) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Title */}
          <MixedText
            text={locale === 'zh' ? '其他筛选条件' : 'Other Filters'}
