    ...
    Object.entries(groupedPlaces).forEach(([key, places]) => {
      ...
      if (isMobile) {
        ...
        const createPopupContent = (index: number) => {
          ...
          // Debug log for food popup
          if (place.restaurantName) {
            console.log('Food popup debug:', {
              locale,
              cuisineStyle: place.cuisineStyle,
              cuisineStyleCN: place.cuisineStyleCN,
              willShow: locale === 'zh' && place.cuisineStyleCN ? place.cuisineStyleCN : place.cuisineStyle
            })
          }
